...
const I18N = (() => {
  ...
  const LOCALE_DATA = {
    'pt-BR': {
      ...
      "editguide.title": "DICAS RÁPIDAS",
      "editguide.hint1": "Clique nos <strong>valores dos registradores</strong> para editar. Use <strong>2× clique</strong> no <strong>MAPA DE MEMÓRIA</strong> para editar bytes.",
      "editguide.hint2": "Edite o programa direto na <strong>LISTAGEM ASM</strong> com <strong>2× clique</strong> em qualquer instrução.",
      "editguide.hint3": "Use <strong>Shift + Clique</strong> em qualquer byte do <strong>MAPA DE MEMÓRIA</strong> para definir ou remover um <strong>Breakpoint</strong>.",
      ...
      "mem.addrdir.total": "0x{0}..0x{1} · total {2}",
    ...
    'en-US': {
      ...
      "editguide.title": "QUICK TIPS",
      "editguide.hint1": "Click on <strong>register values</strong> to edit. Use <strong>double-click</strong> on the <strong>MEMORY MAP</strong> to edit bytes.",
      ...
      "editguide.hint3": "Use <strong>Shift + Click</strong> on any byte in the <strong>MEMORY MAP</strong> to set or remove a <strong>Breakpoint</strong>.",
      "ctrlbar.cpu.title": "CPU",
