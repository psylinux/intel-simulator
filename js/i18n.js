...
const I18N = (() => {
  ...
  const LOCALE_DATA = {
    'pt-BR': {
      ...
      "topbar.pc.title": "Edite EIP/RIP manualmente",
      "topbar.ip.title": "Edite o {0} manualmente",
      ...
      "editguide.hint1": "Clique em <strong>EIP/RIP</strong> e nos <strong>valores dos registradores</strong> para editar. Use <strong>2× clique</strong> no <strong>MAPA DE MEMORIA</strong> para editar bytes.",
      "editguide.hint1.ip": "Clique em <strong>{0}</strong> e nos <strong>valores dos registradores</strong> para editar. Use <strong>2× clique</strong> no <strong>MAPA DE MEMORIA</strong> para editar bytes.",
      ...
      "asm.trace.separator.offflow": "{0} atual fora do fluxo principal. Abaixo, decode local a partir do {0}.",
      "asm.trace.empty": "Nenhuma instrucao disponivel para listar.",
      ...
      "stack.meta.size": "Tamanho da stack",
      "stack.meta.ip": "{0} (Contador)",
      "stack.meta.sp": "{0} (Topo da Pilha)",
      "stack.meta.bp": "{0} (Base do Frame)",
      "stack.meta.ret": "Endereco de retorno",
      "stack.trace.title": "BACKTRACE",
      "stack.trace.hint": "ordem das chamadas ativas e seus enderecos de retorno",
      "stack.trace.empty": "Nenhuma chamada ativa no momento. O programa esta no frame raiz.",
      "stack.trace.extra.root": "Frame raiz: nenhuma chamada ativa e nenhum endereco de retorno pendente.",
      "stack.trace.extra.call": "<span class=\"stack-trace-ret-addr\">RET → 0x{0}</span> · slot [0x{1}] · entrou via {2} @ 0x{3}",
      "stack.trace.label.current": "ATUAL",
      "stack.trace.label.caller": "CHAMADOR",
      "stack.trace.label.root": "RAIZ",
      "stack.row.tag.sp": "{0} topo",
      "stack.row.tag.bp": "{0} base",
      "stack.row.tag.ret": "retorno",
      "stack.row.tag.frame": "frame ativo",
      "stack.row.empty": "livre",
      ...
      "ui.asm.write.title": "Grava bytes no {0} atual. Enter para confirmar.",
      "ui.asm.write.valid": "Valido: {0} byte(s) serao gravados em 0x{1}.",
      "ui.asm.write.invalid": "Invalido: {0}",
      "ui.byte.role.msb": "MSB",
      "ui.byte.role.lsb": "LSB",
      "ui.byte.role.byte": "byte {0}",
      "ui.byte.mem.outside": "fora da largura/operacao atual",
      "ui.byte.mem.offset": "ordem de memoria: A+{0}",
      "ui.byte.hover": "{0} · {1} · {2}",
      ...
      "log.sys.asm_encoded": "ASM: \"{0}\" → [{1}] @ 0x{2}",
      "log.sys.asm_written": "{0} byte(s) gravados em 0x{1}",
      ...
      "log.info.execute_desc": "Aplica os efeitos arquiteturais da instrução decodificada sobre {0}, registradores, memória e stack quando necessário.",
      ...
      "log.error.decode_fail": "Falha de decode em 0x{0}.",
      "log.error.asm_unknown": "ASM: não reconhecido — \"{0}\"",
      "log.error.fail": "Falha: {0}",
      "error.stack.bounds": "{0}: o acesso exige {1} byte(s), de 0x{2} ate 0x{3}, mas a stack simulada vai de 0x0000 ate 0x{4}.",
      "error.mem.width_overflow": "{0}: o acesso de {1} byte(s) a partir de 0x{2} ultrapassa o limite do mapa de memoria (0x3F).",
      ...
      "status.demo_arch": "Programa demo {0} carregado — {1} em 0x0000",
      ...
      "status.demo_reset": "Programa demo restaurado — {0} em 0x0000"
    },
    'en-US': {
      "page.title": "Intel x86/x64 Memory & Stack Lab",
      "topbar.subtitle": "Didactic simulator of memory, registers and stack",
      "topbar.pc.title": "Edit EIP/RIP manually",
      "topbar.ip.title": "Edit {0} manually",
      ...
      "sidebar.reg.label": "REGISTERS",
      "sidebar.speed.label": "SPEED",
      "sidebar.speed.fast": "FAST",
      "sidebar.speed.slow": "SLOW",
      "editguide.title": "QUICK EDIT",
      "editguide.hint1": "Click on <strong>EIP/RIP</strong> and <strong>register values</strong> to edit. Use <strong>double-click</strong> on the <strong>MEMORY MAP</strong> to edit bytes.",
      "editguide.hint1.ip": "Click on <strong>{0}</strong> and <strong>register values</strong> to edit. Use <strong>double-click</strong> on the <strong>MEMORY MAP</strong> to edit bytes.",
      ...
      "asm.trace.separator.offflow": "{0} is outside the main flow. Below is a local decode starting from {0}.",
      "asm.trace.empty": "No instructions available to list.",
      ...
      "stack.cfg.gran.dword": "DWord",
      "stack.cfg.gran.qword": "QWord",
      "stack.meta.size": "Stack size",
      "stack.meta.ip": "{0} (Instruction Pointer)",
      "stack.meta.sp": "{0} (Stack Top)",
      "stack.meta.bp": "{0} (Frame Base)",
      "stack.meta.ret": "Return address",
      "stack.trace.title": "BACKTRACE",
      "stack.trace.hint": "order of active calls and their return addresses",
      "stack.trace.empty": "No active calls at the moment. The program is in the root frame.",
      "stack.trace.extra.root": "Root frame: no active calls and no pending return address.",
      "stack.trace.extra.call": "<span class=\"stack-trace-ret-addr\">RET → 0x{0}</span> · slot [0x{1}] · entered via {2} @ 0x{3}",
      "stack.trace.label.current": "CURRENT",
      "stack.trace.label.caller": "CALLER",
      "stack.trace.label.root": "ROOT",
      "stack.row.tag.sp": "{0} top",
      "stack.row.tag.bp": "{0} base",
      "stack.row.tag.ret": "return",
      "stack.row.tag.frame": "active frame",
      "stack.row.empty": "free",
      ...
      "ui.asm.write.title": "Writes bytes at current {0}. Press Enter to confirm.",
      "ui.asm.write.valid": "Valid: {0} byte(s) will be written at 0x{1}.",
      "ui.asm.write.invalid": "Invalid: {0}",
      "ui.byte.role.msb": "MSB",
      "ui.byte.role.lsb": "LSB",
      "ui.byte.role.byte": "byte {0}",
      "ui.byte.mem.outside": "outside the current transfer width",
      "ui.byte.mem.offset": "memory order: A+{0}",
      "ui.byte.hover": "{0} · {1} · {2}",
      ...
      "help.ops": "<h3>OPERATIONS</h3><p><span class=\"hl\">STORE</span> — Writes the register value to memory, byte by byte. The nibble being sent is highlighted and an animated packet flies to the memory cell.</p><p><span class=\"hl-b\">LOAD</span> — Reads bytes from memory into the register. The register starts at zero and is filled byte by byte in real time — you see the value being built!</p><p><span style=\"color:var(--amb)\">STEP</span> — Executes the full <strong>FETCH → DECODE → EXECUTE</strong> cycle, updating {0}, registers, memory and stack per the instruction.</p><p><span style=\"color:var(--red)\">CLEAR</span> — Resets memory and registers.</p><div class=\"info-box\">💡 Click any memory cell to select that address.<br>💡 In IA-32 transfers use DWORD; in x64 they use QWORD.<br>💡 Slow down to follow each byte carefully.<br>💡 Save 💾 and load 📂 simulations to share.</div>",
      "log.sys.stack_size": "Stack size adjusted to {0}. {1} reset at 0x{2}. Memory map now covers 0x0000..0x{3}.",
      "log.sys.pc_manual": "{0} set manually: 0x{1}",
      "log.sys.stack_located": "Stack 0x{0} located in memory map.",
      "log.sys.pc_moved": "{0} moved to code listing 0x{1}",
      ...
      "log.sys.asm_encoded": "ASM: \"{0}\" → [{1}] @ 0x{2}",
      "log.sys.asm_written": "{0} byte(s) written at 0x{1}",
      ...
      "log.info.execute_desc": "Applies the architectural effects of the decoded instruction on {0}, registers, memory and stack as needed.",
      ...
      "log.error.decode_fail": "Decode failure at 0x{0}.",
      "log.error.asm_unknown": "ASM: unrecognized — \"{0}\"",
      "log.error.fail": "Failure: {0}",
      "error.stack.bounds": "{0}: access requires {1} byte(s), from 0x{2} through 0x{3}, but the simulated stack spans 0x0000 through 0x{4}.",
      "error.mem.width_overflow": "{0}: a {1}-byte access starting at 0x{2} exceeds the memory map limit (0x3F).",
      ...
      "status.demo_arch": "{0} demo program loaded — {1} at 0x0000",
      ...
      "status.demo_reset": "Demo program restored — {0} at 0x0000"
    },
  };
