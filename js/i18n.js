...
const I18N = (() => {
  ...
  const LOCALE_DATA = {
    'pt-BR': {
      ...
      "editguide.hint1": "Clique nos <strong>valores dos registradores</strong> para editar. Use <strong>2× clique</strong> no <strong>MAPA DE MEMORIA</strong> para editar bytes.",
